function closeListWithAnimation() {
  let _ = document.querySelector(".navbar-links"),
...
window.addEventListener("load", function () {
  let _ = document.getElementById("preloader");
  (_.style.transition = "opacity 0.5s"),
    (_.style.opacity = "0"),
    _.addEventListener("transitionend", function () {
      _.parentNode.removeChild(_);
    });
}),
  document.addEventListener("DOMContentLoaded", function () {
    let _ = document.querySelector(".toggle-button"),
      e = document.querySelector(".navbar-links"),
      t = document.getElementById("white");
    _.addEventListener("click", () => {
      e.classList.toggle("active"),
        t.classList.toggle("active", e.classList.contains("active"));
    });
    let $ = e.querySelector(".toggle-caret");
    $ && $.addEventListener("click", closeListWithAnimation);
  });
